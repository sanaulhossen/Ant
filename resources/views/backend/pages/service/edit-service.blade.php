                            ...
                            <div class="form-group">
                                ...
                                <select name="categories_id" id="category" class="form-control">
                                    ...
                                    @foreach($service_category as $data)
                                        <option @if($service->categories_id == $data->id) selected @endif value="{{$data->id}}">{{purify_html($data->lang->name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="price_plan[]" multiple class="form-control nice-select wide">
                                    ...
                                    @foreach($price_plans as $data)
                                        <option value="{{$data->id}}" @if(is_array($select_plan) && in_array($data->id,$select_plan)) selected @endif>{{purify_html($data->lang->title)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
