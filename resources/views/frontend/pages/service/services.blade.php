        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="cleaning-single-item margin-bottom-30">
                    ...
                    <div class="content">
                        <a href="{{route('frontend.services.single',['slug'=>$data->lang->slug,'id'=>$data->id])}}"><h4 class="title">{{$data->lang_front->title}}</h4></a>
                        <a href="{{route('frontend.services.single',['slug'=>$data->lang->slug,'id'=>$data->id])}}"><p>{{$data->lang_front->excerpt}}</p></a>
                    </div>
                </div>
            </div>
            @endforeach 
