                    ...
                    <div class="row">
                        ...
                        <div class="blog-classic-item-01 margin-bottom-60">
                            ...
                            <div class="content">
                                ...
                                <h4 class="title"><a href="{{route('frontend.blog.single',['slug' => $data->blog_front->slug,'id' => $data->id])}}">{{ $data->blog_front->title }}
                                </a></h4>
                                <p>{!! \Str::words(strip_tags($data->blog_front->content),52,'') !!}</p>
                                <div class="btn-wrapper">
                                    <a href="{{route('frontend.blog.single',['slug' => $data->blog_front->slug, 'id' => $data->id])}}" class="boxed-btn">{{__('Read More')}}</a>
                                </div>
                            </div>
                        </div> 
                        @endforeach
