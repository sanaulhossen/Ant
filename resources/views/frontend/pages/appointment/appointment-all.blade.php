                        ...
                        <div class="right-part">
                            <select name="category" class="form-control">
                                ...
                                @foreach($category_list as $category)
                                    <option @if($category->id == $cat_id) selected @endif value="{{$category->id}}">{{$category->lang_front->name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="appointment-single-item">
                            ...
                            <div class="content">
                               <div class="top-part">
                                ...
                                <a href="{{route('frontend.appointment.single',['slug' => $data->lang_front->slug, 'id' => $data->id])}}"><h4 class="title">{{$data->lang_front->title}}</h4></a>
                                ...
                                <div class="btn-wrapper">
                                    <a href="{{route('frontend.appointment.single',['slug' => $data->lang_front->slug, 'id' => $data->id])}}" class="boxed-btn">{{get_static_option('appointment_page_'.$user_select_lang_slug.'_booking_button_text')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
