...
<meta name="title" content="{{$item->lang_front->meta_title}}">
<meta name="tags" content="{{$item->lang_front->meta_tags}} ">
<meta name="description" content="{{$item->lang_front->meta_description}}">
@endsection
@section('og-meta')
<meta name="og:title" content="{{$item->lang_front->og_meta_title}}">
<meta name="og:description" content="{{$item->lang_front->og_meta_description}}">
{!! render_og_meta_image_by_attachment_id($item->lang_front->og_meta_image) !!}
@php
  $post_img = null;
                           ...
                           <div class="content">
                               ...
                               <div class="social-share-wrap">
                                   <ul class="social-share">
                                       {!! single_post_share(route('frontend.appointment.single',['slug' => $item->lang_front->slug, 'id' => $item->id]),$item->title,get_attachment_url_by_id($item->image,'full')) !!}
                                   </ul>
                               </div>
                           </div>
                       </div>
                                                        ...
                                                        <div class="tab-content" >
                                                            @if(!auth()->guard('web')->check())
                                                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                                                    ...
                                                                    @if(!auth()->guard('web')->check())
                                                                        <div class="next-step">
                                                                            <button class="next-step-btn btn-small" style="display: none" type="button">{{__('Next Step')}}</button>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            @endif
                                                            <div class="tab-pane fade @if(auth()->guard('web')->check()) show active @endif" id="nav-profile" role="tabpanel">
                                                                ...
                                                                <form action="{{route('frontend.appointment.booking')}}" method="post" class="appointment-booking-form" id="appointment-booking-form">
                                                                    ...
                                                                    <div class="button-wrap">
                                                                        <button type="submit" class="btn-small btn-block appointment appo_booking_btn">{{get_static_option('appointment_single_'.$user_select_lang_slug.'_appointment_booking_button_text')}} <i class="fas fa-spinner fa-spin d-none"></i></button>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <div class="order-tab-wrap">
                                                        <div class="tab-content" >
                                                            ...
                                                            <div class="alert alert-warning alert-block">
                                                                ...
                                                                <strong>{{ __('You must login or create an account to continue!') }}</strong>
                                                            </div>
                                                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                                                    @if(!auth()->guard('web')->check())
                                                                        @include('frontend.partials.ajax-form.ajax-login-form')
                                    ...
                                    <div class="feedback-wrapper">
                                        ...
                                        <div class="feedback-form-wrapper">
                                            ...
                                            <form action="{{route('frontend.appointment.review')}}" method="post" class="appointment-booking-form" id="appointment_rating_form">
                                                ...
                                                <button type="submit" class="btn-small appointment" id="appointment_ratings"><i class="fas fa-spinner fa-spin d-none"></i> {{__('Submit')}} </button>
                                            </form>
                                        </div>`
                                        @else
                                            @include('frontend.partials.ajax-form.ajax-login-form')
...
@section('scripts')
    <script type="text/javascript" src="{{asset('assets/frontend/js/fontawesome-mod.js')}}"></script>
