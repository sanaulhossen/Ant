            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        <h1 class="title text-center">{{get_static_option('product_success_page_' . $user_select_lang_slug . '_title')}}</h1>
                        ...
                        <div class="ordered-product-summery margin-top-30">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($cart_items as $item)
                                    @php $product_info = \App\Products::with('lang_front')->find($item['id']);@endphp
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="{{route('frontend.products.single',['slug'=>$product_info->lang_front->slug,'id'=>$product_info->id])}}">{{$product_info->lang_front->title}}</a></h4>
