                ...
                <div class="col-lg-3 order-lg-1">
                    <div class="product-widget-area">
                        <div class="widget widget_nav_menu product-widget">
                            ...
                            <ul class="product_category_list">
                                @foreach($all_category as $data)
                                    <li><a data-catid="{{$data->id}}" href="{{route('frontend.products.category',['id' => $data->id,'any' => Str::slug($data->category_front->name)])}}" @if($data->id == $selected_category) class="active" @endif>{{$data->category_front->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="widget widget_price_filter product-widget">
                            ...
                            <button type="button" class="btn-small style-01" id="submit_price_filter_btn">{{__("Apply Filter")}}</button>
                        </div>
