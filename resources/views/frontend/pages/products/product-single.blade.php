...
@section('site-title')
    {{$product->lang_front->title}}
@endsection
@section('page-title')
    {{$product->lang_front->title}}   
@endsection
@section('page-meta-data')
<meta name="title" content="{{$product->lang_front->meta_title}}">
<meta name="tags" content="{{$product->lang_front->meta_tags}} ">
<meta name="description" content="{{$product->lang_front->meta_description}}">
@endsection
@section('og-meta')
<meta name="og:title" content="{{$product->lang_front->og_meta_title}}">
<meta name="og:description" content="{{$product->lang_front->og_meta_description}}">
{!! render_og_meta_image_by_attachment_id($product->lang_front->og_meta_image) !!}
@php
        $post_img = null;
                        ...
                        <div class="top-content">
                            ...
                            <div class="product-summery">
                                ...
                                <div class="short-description">
                                    <p>{{$product->lang_front->short_description}}</p>
                                </div>
                                ...
                                <div class="cat-sku-content-wrapper">
                                    ...
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           ...
                                           {!! single_post_share(route('frontend.blog.single',['slug'=>$product->lang_front->slug,'id'=>$product->id]),$product->title,$post_img) !!}
                                       </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel">
                                        <div class="product-description">
                                            {!! $product->lang_front->description !!}
                                        </div>
                                    </div>
                                    @if(!empty($product_attributes_title[0]))
                                    ...
                                    @foreach($related_products as $data)
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                <div class="thumb">
                                                    <a href="{{route('frontend.products.single',['slug'=>$data->lang_front->slug,'id'=>$data->id])}}">
                                                        <div class="img-wrapper">
                                                            {!! render_image_markup_by_attachment_id($data->image,'','grid') !!}
                                                        </div>
                                                    </a>
                                                    @if(!empty($data->lang_front->badge))
                                                        <span class="tag">{{$data->lang_front->badge}}</span>
                                                    @endif
                                                </div>
                                                <div class="content">
                                                    <a href="{{route('frontend.products.single',['slug'=>$data->lang_front->slug,'id'=>$data->id])}}">
                                                    ...
                                                    @else
                                                        <a href="{{route('frontend.products.add.to.cart')}}"
                                                           ...
                                                           data-product_title="{{$data->lang_front->title}}"
