...
<?php $__env->startSection('content'); ?>
    <div class="payment-page-content padding-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area margin-bottom-80">
                        <h1 class="title text-center"><?php echo e(get_static_option('appointment_booking_'.$user_select_lang_slug.'_success_page_title' )); ?></h1>
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="booking_details_list">
                        ...
                        <li><strong><?php echo e(__('Fre')); ?></strong> : <?php echo e(amount_with_currency_symbol($booking->total)); ?></li>
                        ...
                        <li><strong><?php echo e(__('Booking Date')); ?></strong> : <?php echo e(date('D d, F Y',strtotime($booking->booking_date))); ?></li>
                        <li><strong><?php echo e(__('Booking Time')); ?></strong> : <?php echo e($booking->booking_time->time); ?></li>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/appointment/payment-success.blade.php ENDPATH**/ ?>