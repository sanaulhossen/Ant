<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Testimonial Area Settings')); ?>
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.home.testimonial')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                            ...
                            <div class="tab-content margin-top-20" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <div class="form-group">
                                        <label for="home_page_testimonial_section_<?php echo e($lang->slug); ?>_title"><?php echo e(__('Title')); ?></label>
                                        <input type="text" class="form-control" name="home_page_testimonial_section_<?php echo e($lang->slug); ?>_title" value="<?php echo e(get_static_option('home_page_testimonial_section_'.$lang->slug.'_title')); ?>" placeholder="<?php echo e(__('Title')); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/pages/home-page-manage/testimonial-settings.blade.php ENDPATH**/ ?>