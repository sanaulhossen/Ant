<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Package Order Details')); ?>
                ...
                <div class="card">
                    <div class="card-body">
                       <div class="header-wrap d-flex justify-content-between margin-bottom-40">
                           <h4 class="header-title"><?php echo e(__('Package Order Details')); ?></h4>
                           <a href="<?php echo e(route('admin.package.order.manage.all')); ?>" class="btn btn-info"><?php echo e(__('All Package Orders')); ?></a>
                       </div>
                        <div class="booking-details-info">
                            <ul>
                                <li><strong><?php echo e(__('Order ID')); ?></strong> : #<?php echo e($order->id); ?></li>
                                <li><strong><?php echo e(__('Package Name')); ?></strong> : <?php echo e($order->package_name); ?></li>
                                <li><strong><?php echo e(__('Package Price')); ?></strong> : <?php echo e(amount_with_currency_symbol($order->package_price)); ?></li>
                                <li><strong><?php echo e(__('Payment Status')); ?></strong> : <?php echo e($order->payment_status); ?></li>
                                <li><strong><?php echo e(__('Status')); ?></strong> : <?php echo e($order->status); ?></li>
                                <?php
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/package-order-manage/order-manage-view.blade.php ENDPATH**/ ?>