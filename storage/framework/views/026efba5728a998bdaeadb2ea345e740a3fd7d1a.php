...
<?php endif; ?>
                                                        ...
                                                        <form action="<?php echo e(route('admin.package.order.reminder')); ?>"  method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                                                            <button class="btn btn-secondary mb-2" type="submit"><i class="fas fa-bell"></i></button>
                                                        </form>
                                                        <?php endif; ?>
                                                        <?php if(!empty($data->paymentlog)): ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/package-order-manage/order-manage-all.blade.php ENDPATH**/ ?>