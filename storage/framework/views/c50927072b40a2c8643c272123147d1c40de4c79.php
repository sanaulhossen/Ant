                    ...
                    <div class="card-body">
                        <div class="header-wrapp">
                            ...
                            <div class="header-title">
                                <a href="<?php echo e(route('admin.blog.new')); ?>" id="add_post" class="btn btn-primary mt-4 pr-4 pl-4"> <i class="fas fa-plus mr-1"></i> <?php echo e(__('Add New Post')); ?></a>
                            </div>
                        </div>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?></td>
                                        ...
                                        <td> <?php
                                            $img = get_attachment_image_by_id($data->lang->image,null,true);
                                            ?>
                                            <?php if(!empty($img)): ?>
...
<?php endif; ?>
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.view-icon','data' => ['url' => route('frontend.blog.single',['slug' => $data->lang->slug, 'id' => $data->id])]]); ?>
<?php $component->withName('view-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('frontend.blog.single',['slug' => $data->lang->slug, 'id' => $data->id]))]); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/pages/blog/index.blade.php ENDPATH**/ ?>