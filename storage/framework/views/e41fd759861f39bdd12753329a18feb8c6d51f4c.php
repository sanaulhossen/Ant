            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.services')); ?>" method="post" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($loop->first): ?> show active <?php endif; ?>" id="slider_tab_<?php echo e($lang->slug); ?>" role="tabpanel" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="excerpt[<?php echo e($lang->slug); ?>]" cols="30" rows="5" class="form-control"></textarea>
                                            <small class="info-text"><?php echo e(__('it will show service item shortdetails.')); ?></small>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="categories_id" class="form-control" id="category">
                                    ...
                                    <?php $__currentLoopData = $service_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"><?php echo e($category->lang->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="price_plan[]" multiple class="form-control nice-select wide">
                                    <?php $__currentLoopData = $price_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>"><?php echo e(purify_html($data->lang->title)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="sr_order"><?php echo e(__('Order')); ?></label>
                                <input type="number" class="form-control"  value="<?php echo e(old('sr_order')); ?>"  name="sr_order" placeholder="<?php echo e(__('eg: 1')); ?>">
...
<?php endif; ?>
                            ...
                            <button type="submit" id="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add Service')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/pages/service/new-service.blade.php ENDPATH**/ ?>