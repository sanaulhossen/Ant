    ...
    <div id="notfound">
        <div class="notfound">
            <div class="notfound-404">
                <h1><?php echo e(get_static_option('error_404_page_'.get_user_lang().'_title')); ?></h1>
            </div>
            <h2><?php echo e(get_static_option('error_404_page_'.get_user_lang().'_subtitle')); ?></h2>
            <p><?php echo e(get_static_option('error_404_page_'.get_user_lang().'_paragraph')); ?></p>
            <a href="<?php echo e(route('homepage')); ?>"><?php echo e(get_static_option('error_404_page_'.get_user_lang().'_button_text')); ?></a>
        </div>
    </div>
</body>
</html>
<?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/404.blade.php ENDPATH**/ ?>