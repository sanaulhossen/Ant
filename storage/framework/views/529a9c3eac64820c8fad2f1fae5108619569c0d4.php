                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('frontend.products.single',[$data['slug'],$data['id']])); ?>"><h4 style="font-weight: 600;"><?php echo e($data['title']); ?></h4></a>
                                <div>
                            ...
                            <td>
                                <a class="btn btn-xs btn-success btn-boxed style-01 margin-bottom-10" href="<?php echo e(route('user.dashboard.download.file',$data['id'])); ?>"><i class="fas fa-download"></i>  <?php echo e(__('Download File')); ?></a>
                            </td>
                        </tr>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/dashboard/product-downloads.blade.php ENDPATH**/ ?>