                        ...
                        <div class="right-part">
                            <select name="category" class="form-control">
                                ...
                                <?php $__currentLoopData = $category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php if($category->id == $cat_id): ?> selected <?php endif; ?> value="<?php echo e($category->id); ?>"><?php echo e($category->lang_front->name); ?></option>
                        ...
                        <div class="appointment-single-item">
                            ...
                            <div class="content">
                               <div class="top-part">
                                ...
                                <a href="<?php echo e(route('frontend.appointment.single',['slug' => $data->lang_front->slug, 'id' => $data->id])); ?>"><h4 class="title"><?php echo e($data->lang_front->title); ?></h4></a>
                                ...
                                <div class="btn-wrapper">
                                    <a href="<?php echo e(route('frontend.appointment.single',['slug' => $data->lang_front->slug, 'id' => $data->id])); ?>" class="boxed-btn"><?php echo e(get_static_option('appointment_page_'.$user_select_lang_slug.'_booking_button_text')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/appointment/appointment-all.blade.php ENDPATH**/ ?>