                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-danger alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i> <?php echo e(__("Note: Please, don't add Name & Email Form Fields here!")); ?></strong>
                        </div>
                        <form action="<?php echo e(route('admin.form.builder.order')); ?>" method="Post"><?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('order_page_form_fields')); ?>

                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4 margin-bottom-40"
                                    id="save"><?php echo e(__('Save Change')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul id="sortable_02" class="available-form-field">
                            ...
                            <li class="ui-state-default" dype="file"><span
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/form-builder/order-form.blade.php ENDPATH**/ ?>