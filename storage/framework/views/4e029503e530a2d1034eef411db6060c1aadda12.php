...
<?php endif; ?>
                                                    ...
                                                    <div class="login-form">
                                                        <form action="<?php echo e(route('user.login')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01" id="login_form_order_page">
                                                            ...
                                                            <div class="form-group btn-wrapper">
                                                                <button type="submit" id="login_btn" class="submit-btn btn-small"><?php echo e(__('Login')); ?></button>
                                                            </div>
                       ...
                       <div class="cart-total-wrap">
                        ...
                        <a href="<?php echo e(route('ssl.checkout')); ?>" class="btn-small"><?php echo e(__('SSLCommence')); ?></a>
                           ...
                           <div class="form-group manual_payment_transaction_field <?php if(get_static_option('site_default_payment_gateway') == 'manual_payment'): ?> show <?php endif; ?> ">
                            ...
                            <?php endif; ?>
                           <a href="<?php echo e(route('frontend.products.checkout')); ?>" class="btn-small cart-view checkout_form_submit_btn"><?php echo e(__('Confirm Order')); ?></a>
                       </div>
                   </div>
                    <?php else: ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SANAUL\Desktop\code canyan\cleaning\@core\resources\views/frontend/pages/products/product-checkout.blade.php ENDPATH**/ ?>