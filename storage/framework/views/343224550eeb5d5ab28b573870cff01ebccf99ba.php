            ...
            <div class="col-lg-8">
                <?php $__currentLoopData = $all_blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="blog-classic-item-01 margin-bottom-60">
                            <div class="thumbnail">
                                <?php echo render_image_markup_by_attachment_id($data->lang_front->image); ?>

                                <div class="news-date">
                                    <h5 class="title"><?php echo e(date('d',strtotime($data->lang_front->created_at))); ?></h5>
                                    <span><?php echo e(date('M',strtotime($data->lang_front->created_at))); ?></span>
                                </div>
                            </div>
                            <div class="content">
                                <ul class="post-meta">
                                    <li><i class="far fa-user"></i> <?php echo e(($data->lang_front->author) ?? __("Anonymous")); ?></li>
                                    <li><i class="far fa-calendar-alt"></i> <?php echo e($data->lang_front->created_at->diffForHumans()); ?></li>
                                </ul>
                                <h4 class="title"><a href="<?php echo e(route('frontend.blog.single',['slug' => $data->lang_front->slug, 'id' => $data->id])); ?>"><?php echo e($data->lang_front->title); ?>

                                </a></h4>
                                
                                <div class="btn-wrapper">
                                    <a href="<?php echo e(route('frontend.blog.single',['slug' => $data->lang_front->slug, 'id' => $data->id])); ?>" class="boxed-btn"><?php echo e(__('Read More')); ?></a>
                                </div>
                            </div>
                        </div> 
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/blog.blade.php ENDPATH**/ ?>