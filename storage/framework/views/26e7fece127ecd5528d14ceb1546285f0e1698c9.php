...
<?php $__env->startSection('content'); ?>
    <div class="product-page-content padding-120">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        <h1 class="title text-center"><?php echo e(get_static_option('product_success_page_' . $user_select_lang_slug . '_title')); ?></h1>
                        <p><?php echo e(get_static_option('product_success_page_' . $user_select_lang_slug . '_description')); ?></p>
                        <div class="product-orders-summery-warp margin-top-30">
                        ...
                        <div class="ordered-product-summery margin-top-30">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php $__currentLoopData = $cart_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $product_info = \App\Products::with('lang_front')->find($item['id']);?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="<?php echo e(route('frontend.products.single',['slug'=>$product_info->lang_front->slug,'id'=>$product_info->id])); ?>"><?php echo e($product_info->lang_front->title); ?></a></h4>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/products/product-success.blade.php ENDPATH**/ ?>