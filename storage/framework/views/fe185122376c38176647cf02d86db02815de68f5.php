...
<head>
    ...
    <link rel=icon href=<?php echo e(asset('assets/common/favicon.ico')); ?> sizes="20x20" type="image/png">
    <!-- animate -->
...
<body>
    ...
    <?php endif; ?>
    <!-- preloader area end --><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/partials/header.blade.php ENDPATH**/ ?>