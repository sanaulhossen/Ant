...
<meta name="title" content="<?php echo e($item->lang_front->meta_title); ?>">
<meta name="tags" content="<?php echo e($item->lang_front->meta_tags); ?> ">
<meta name="description" content="<?php echo e($item->lang_front->meta_description); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('og-meta'); ?>
<meta name="og:title" content="<?php echo e($item->lang_front->og_meta_title); ?>">
<meta name="og:description" content="<?php echo e($item->lang_front->og_meta_description); ?>">
<?php echo render_og_meta_image_by_attachment_id($item->lang_front->og_meta_image); ?>
                           ...
                           <div class="content">
                               ...
                               <div class="social-share-wrap">
                                   <ul class="social-share">
                                       <?php echo single_post_share(route('frontend.appointment.single',['slug' => $item->lang_front->slug, 'id' => $item->id]),$item->title,get_attachment_url_by_id($item->image,'full')); ?>
                                                        ...
                                                        <div class="tab-content" >
                                                            <?php if(!auth()->guard('web')->check()): ?>
                                                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                                                    <div class="checkout-type margin-bottom-30"  <?php if(auth()->guard('web')->check()): ?> style="display: none"  <?php endif; ?>>
                                                                    ...
                                                                    <?php if(!auth()->guard('web')->check()): ?>
                                                                        <div class="next-step">
                                                                            <button class="next-step-btn btn-small" style="display: none" type="button"><?php echo e(__('Next Step')); ?></button>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php endif; ?>
                                                            <div class="tab-pane fade <?php if(auth()->guard('web')->check()): ?> show active <?php endif; ?>" id="nav-profile" role="tabpanel">
                                                                ...
                                                                <form action="<?php echo e(route('frontend.appointment.booking')); ?>" method="post" class="appointment-booking-form" id="appointment-booking-form">
                                                                    ...
                                                                    <div class="button-wrap">
                                                                        <button type="submit" class="btn-small btn-block appointment appo_booking_btn"><?php echo e(get_static_option('appointment_single_'.$user_select_lang_slug.'_appointment_booking_button_text')); ?> <i class="fas fa-spinner fa-spin d-none"></i></button>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <div class="order-tab-wrap">
                                                        <div class="tab-content" >
                                                            ...
                                                            <div class="alert alert-warning alert-block">
                                                                ...
                                                                <strong><?php echo e(__('You must login or create an account to continue!')); ?></strong>
                                                            </div>
                                                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                                                    <?php if(!auth()->guard('web')->check()): ?>
                                                                        <?php echo $__env->make('frontend.partials.ajax-form.ajax-login-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <div class="feedback-wrapper">
                                        ...
                                        <div class="feedback-form-wrapper">
                                            ...
                                            <form action="<?php echo e(route('frontend.appointment.review')); ?>" method="post" class="appointment-booking-form" id="appointment_rating_form">
                                                ...
                                                <button type="submit" class="btn-small appointment" id="appointment_ratings"><i class="fas fa-spinner fa-spin d-none"></i> <?php echo e(__('Submit')); ?> </button>
                                            </form>
                                        </div>`
                                        <?php else: ?>
                                            <?php echo $__env->make('frontend.partials.ajax-form.ajax-login-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/fontawesome-mod.js')); ?>"></script>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/appointment/single.blade.php ENDPATH**/ ?>