...
<div class="header-slider-one">
    <?php $__currentLoopData = $heaer_sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="header-area style-02 header-bg-03" <?php echo render_background_image_markup_by_attachment_id($data->image); ?>>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
...
<?php if(get_static_option('home_page_keyfeature_section_status')): ?>
    <?php echo $__env->make('frontend.partials.keyfeature.keyfeature-variant-02', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php if(get_static_option('home_page_call_us_section_status')): ?>
    <?php echo $__env->make('frontend.partials.call-us-now-banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/home-pages/home-03.blade.php ENDPATH**/ ?>