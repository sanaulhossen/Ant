...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.custom-alert','data' => ['msg' => __('Are you sure to make this language as a default language?'),'url' => route('admin.languages.default',$data->id),'text' => __('Make default'),'alerttype' => 'warning','alertbtntext' => __('Make Default')]]); ?>
<?php $component->withName('custom-alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['msg' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Are you sure to make this language as a default language?')),'url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.languages.default',$data->id)),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Make default')),'alerttype' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('warning'),'alertbtntext' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Make Default'))]); ?>
...
<?php endif; ?>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.languages.words.backend',$data->slug)); ?>"
                                           title="<?php echo e(__('Edit Admin Panel Words')); ?>"
                                           class="btn btn-secondary btn-xs mb-3 mr-1 text-white" >
                                            <i class="ti-pencil"></i> <?php echo e(__('Edit Admin Words')); ?>

                                        </a>
                                        <a href="<?php echo e(route('admin.languages.words.frontend',$data->slug)); ?>"
                                           title="<?php echo e(__('Edit Frontend Words')); ?>" class="btn btn-info btn-xs mb-3 mr-1 text-white"
                                           >
                                            <i class="ti-pencil"></i> <?php echo e(__('Edit Frontend Words')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/languages/index.blade.php ENDPATH**/ ?>