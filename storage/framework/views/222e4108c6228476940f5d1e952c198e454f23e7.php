                       ...
                       <div class="header-wrap d-flex justify-content-between margin-bottom-40">
                        ...
                        <div class="booking-details-info">
                            <ul>
                                ...
                                <li><strong><?php echo e(__('Appointment Fee')); ?></strong> : <?php echo e(amount_with_currency_symbol($booking_details->total)); ?></li>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/appointment/appointment-booking-view.blade.php ENDPATH**/ ?>