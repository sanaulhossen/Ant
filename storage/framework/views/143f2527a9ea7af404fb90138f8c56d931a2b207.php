<div class="eco-friendly-area padding-top-120 padding-bottom-120">
    <div class="bg-img-02" <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_full_width_service_section_'.$home_variant_number.'_bg_img_right')); ?>></div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
</div><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/partials/full-width-service/full-width-service-variant-03.blade.php ENDPATH**/ ?>