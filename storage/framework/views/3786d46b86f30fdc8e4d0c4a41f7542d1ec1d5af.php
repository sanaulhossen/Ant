                                ...
                                <div class="user-dahsboard-order-info-wrap">
                                    <h5 class="title">
                                        <?php if(!empty($data->appointment)): ?>
                                            <a href="<?php echo e(route('frontend.appointment.single',[$data->appointment->slug,$data->appointment->appointment_id])); ?>"><?php echo e($data->appointment->title); ?></a>
                                        <?php else: ?>
                                ...
                                <?php if($data->status == 'pending'): ?>
                                    ...
                                    <?php if( $data->payment_gateway != 'manual_payment'): ?>
                                        <form action="<?php echo e(route('frontend.appointment.booking')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm margin-top-20"><?php echo e(__('Pay Now')); ?></button>
                                        </form>
                                    <?php endif; ?>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/dashboard/appointment-order.blade.php ENDPATH**/ ?>