                    ...
                    <?php $__currentLoopData = $product_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                ...
                                <div class="user-dahsboard-order-info-wrap">
                                    ...
                                    <?php if($data->payment_status == 'complete'): ?>
                                        <form action="<?php echo e(route('frontend.product.invoice.generate')); ?>"  method="post">
                                            ...
                                            <button class="btn btn-secondary btn-sm" type="submit"> <i class="fas fa-download"></i> <?php echo e(__('Invoice')); ?></button>
                                        </form>
                                    <?php endif; ?>
                                </div>
                            </th>
                            <td>
                                <?php if($data->payment_status == 'pending' && $data->status != 'cancel'): ?>
                                    ...
                                    <?php if( $data->payment_gateway != 'cash_on_delivery' &&  $data->payment_gateway != 'manual_payment'): ?>
                                        <form action="<?php echo e(route('frontend.products.checkout')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="billing_district" value="<?php echo e($data->billing_district); ?>">
                                            <button type="submit" class="btn btn-sm btn-success margin-top-30"><?php echo e(__('Pay Now')); ?></button>
                                        </form>
                                    <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('user.dashboard.product.order.view',$data->id)); ?>" target="_blank" class="btn btn-sm btn-info"><?php echo e(__('View Order')); ?></a>
                            </td>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/dashboard/product-order.blade.php ENDPATH**/ ?>