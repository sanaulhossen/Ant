        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <input type="hidden" value="<?php echo e(get_cart_total_cost()); ?>" name="amount" id="total_amount" required/>
                ...
                <button class="btn btn-primary btn-lg btn-block" id="sslczPayBtn"
                        ...
                        endpoint="<?php echo e(url('/pay-via-ajax')); ?>"> Pay Now
                </button>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\Users\SANAUL\Desktop\code canyan\cleaning\@core\resources\views/exampleEasycheckout.blade.php ENDPATH**/ ?>