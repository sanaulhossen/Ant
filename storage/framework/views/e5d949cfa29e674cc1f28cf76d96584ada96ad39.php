                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($data->payment_status == 'pending' && $data->status != 'cancel'): ?>
                                ...
                                <a href="<?php echo e(route('frontend.order.confirm',$data->id)); ?>" class="btn btn-success btn-sm"><?php echo e(__('Pay Now')); ?></a>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/dashboard/package-order.blade.php ENDPATH**/ ?>