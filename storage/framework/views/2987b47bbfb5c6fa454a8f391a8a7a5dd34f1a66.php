                ...
                <td>
                    <div class="product-info-wrap">
                        ...
                        <?php if(get_static_option('product_tax_type') == 'individual' && is_tax_enable()): ?>
                            ...
                            ?>
                            <span class="pdetails pdetails-mod"><strong><?php echo e(__('Tax')); ?> <?php echo e(($percentage.'% :')); ?></strong> +<?php echo e(amount_with_currency_symbol($tax_amount)); ?></span>
                        <?php endif; ?>
...
<?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/mail/product-order.blade.php ENDPATH**/ ?>