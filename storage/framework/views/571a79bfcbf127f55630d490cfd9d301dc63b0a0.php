                        ...
                        <form action="<?php echo e(route('admin.new.user')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <ul class="text-danger">
                                    <li><?php echo e(__('Editors ( Have access everything except user role manage/general settings/language   )')); ?></li>
                                    <li><?php echo e(__('Admin ( Have access everything except user role manage )')); ?></li>
                                    <li><?php echo e(__('Super_Admin ( Have everything access )')); ?></li>
                                </ul>
                            </div>
                            <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/neateller-laravel/@core/resources/views/backend/user-role-manage/add-new-user.blade.php ENDPATH**/ ?>