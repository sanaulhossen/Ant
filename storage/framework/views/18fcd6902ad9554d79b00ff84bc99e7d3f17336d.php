                    ...
                    <div class="row">
                        ...
                        <div class="blog-classic-item-01 margin-bottom-60">
                            ...
                            <div class="content">
                                ...
                                <h4 class="title"><a href="<?php echo e(route('frontend.blog.single',['slug' => $data->blog_front->slug,'id' => $data->id])); ?>"><?php echo e($data->blog_front->title); ?>

                                </a></h4>
                                <p><?php echo \Str::words(strip_tags($data->blog_front->content),52,''); ?></p>
                                <div class="btn-wrapper">
                                    <a href="<?php echo e(route('frontend.blog.single',['slug' => $data->blog_front->slug, 'id' => $data->id])); ?>" class="boxed-btn"><?php echo e(__('Read More')); ?></a>
                                </div>
                            </div>
                        </div> 
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/blog-category.blade.php ENDPATH**/ ?>