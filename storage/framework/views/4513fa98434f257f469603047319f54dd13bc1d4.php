            ...
            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="single-product-item-3 margin-bottom-30">
                                        ...
                                        <div class="content">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('frontend.products.single',['slug'=>$data->lang_front->slug,'id'=>$data->id])); ?>">
                                                <h4 class="title"><?php echo e(Str::words($data->lang_front->title,5)); ?></h4>
                                            </a>
                ...
                <div class="col-lg-3 order-lg-1">
                    <div class="product-widget-area">
                        <div class="widget widget_nav_menu product-widget">
                            ...
                            <ul class="product_category_list">
                                <?php $__currentLoopData = $all_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a data-catid="<?php echo e($data->id); ?>" href="<?php echo e(route('frontend.products.category',['id' => $data->id,'any' => Str::slug($data->category_front->name)])); ?>" <?php if($data->id == $selected_category): ?> class="active" <?php endif; ?>><?php echo e($data->category_front->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <div class="widget widget_price_filter product-widget">
                            ...
                            <button type="button" class="btn-small style-01" id="submit_price_filter_btn"><?php echo e(__("Apply Filter")); ?></button>
                        </div>
                        <div class="widget widget_rating_filter product-widget">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/products/products.blade.php ENDPATH**/ ?>