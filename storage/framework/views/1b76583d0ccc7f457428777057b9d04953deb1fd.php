            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 margin-bottom-120 margin-top-60">
                    <div class="login-form-wrapper contact-form">
                        <h3 class="text-center title margin-bottom-30"><?php echo e(__('Register New Account')); ?></h3>
                        ...
                        <form action="<?php echo e(route('user.register')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group btn-wrapper">
                                <button class="boxed-btn btn-block" id="register" type="submit"><?php echo e(__('Register')); ?></button>
                            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/register.blade.php ENDPATH**/ ?>