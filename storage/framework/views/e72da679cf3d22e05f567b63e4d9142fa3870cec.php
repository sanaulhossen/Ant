<?php $__env->startSection('site-title'); ?>
    <?php echo e($product->lang_front->title); ?>
...
<meta name="title" content="<?php echo e($product->lang_front->meta_title); ?>">
<meta name="tags" content="<?php echo e($product->lang_front->meta_tags); ?> ">
<meta name="description" content="<?php echo e($product->lang_front->meta_description); ?>">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('og-meta'); ?>
<meta name="og:title" content="<?php echo e($product->lang_front->og_meta_title); ?>">
<meta name="og:description" content="<?php echo e($product->lang_front->og_meta_description); ?>">
<?php echo render_og_meta_image_by_attachment_id($product->lang_front->og_meta_image); ?>
                            ...
                            <div class="product-summery">
                                ...
                                <div class="price-wrap">
                                    ...
                                    <?php if(!empty($product->regular_price)): ?>
                                        <del
                                            class="del-price"><?php echo e(amount_with_currency_symbol($product->regular_price)); ?></del><?php endif; ?>
                                </div>
                                <div class="short-description">
                                    <p><?php echo e($product->lang_front->short_description); ?></p>
                                </div>
                                ...
                                <div class="cat-sku-content-wrapper">
                                    ...
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           ...
                                           <?php echo single_post_share(route('frontend.blog.single',['slug'=>$product->lang_front->slug,'id'=>$product->id]),$product->title,$post_img); ?>
                            ...
                            <div class="extra-content-wrap">
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <?php
                                        $product_attributes_title = unserialize($product->lang_front->attributes_title);
                                        ?>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel">
                                        <div class="product-description">
                                            <?php echo $product->lang_front->description; ?>
                                    ...
                                    <?php if(!empty($product_attributes_title[0])): ?>
                                        <div class="tab-pane fade" id="nav-attributes" role="tabpanel">
                                            <?php
                                                $att_title = unserialize($product->lang_front->attributes_title);
                                                $att_descr = unserialize($product->lang_front->attributes_description);
                                            ?>
                                                ...
                                                <?php if(auth()->check()): ?>
                                                    ...
                                                    <form action="<?php echo e(route('product.ratings.store')); ?>" method="post"
                                                        ...
                                                        <div class="btn-wrapper">
                                                            <button type="submit"
                                                                    class="btn-small style-01"><?php echo e(__('Submit')); ?></button>
                                                        </div>
                                                    </form>
                                                <?php else: ?>
                                                  <?php echo $__env->make('frontend.partials.ajax-form.ajax-login-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php $__currentLoopData = $related_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                <div class="thumb">
                                                    <a href="<?php echo e(route('frontend.products.single',['slug'=>$data->lang_front->slug,'id'=>$data->id])); ?>">
                                                        <div class="img-wrapper">
                                                            <?php echo render_image_markup_by_attachment_id($data->image,'','grid'); ?>

                                                        </div>
                                                    </a>
                                                    <?php if(!empty($data->lang_front->badge)): ?>
                                                        <span class="tag"><?php echo e($data->lang_front->badge); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="content">
                                                    <a href="<?php echo e(route('frontend.products.single',['slug'=>$data->lang_front->slug,'id'=>$data->id])); ?>">
                                                        <h4 class="title"><?php echo e($data->lang_front->title); ?></h4>
                                                    </a>
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('frontend.products.add.to.cart')); ?>"
                                                           ...
                                                           data-product_title="<?php echo e($data->lang_front->title); ?>"
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/frontend/js/fontawesome-mod.js')); ?>"></script>
    ...
    <?php echo $__env->make('frontend.partials.ajax-form.ajax-login-form-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        (function ($) {
            "use strict";
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>