<script>
    (function ($) {
        ...
        $(document).on('click','.media_library_image_delete_btn',function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('admin.upload.media.file.delete')); ?>",
                data: {
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('admin.upload.media.file.alt.change')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        function loadAllImages() {
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('admin.upload.media.file.all')); ?>",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>"
                },
                success: function (data) {
...
<?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/neateller-laravel/@core/resources/views/backend/partials/media-upload/media-js.blade.php ENDPATH**/ ?>