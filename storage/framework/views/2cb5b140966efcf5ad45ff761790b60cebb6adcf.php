                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.popup.settings')); ?>" method="Post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="popup_delay_time" id="popup_delay_time" value="<?php echo e(get_static_option('popup_delay_time')); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/general-settings/popup-settings.blade.php ENDPATH**/ ?>