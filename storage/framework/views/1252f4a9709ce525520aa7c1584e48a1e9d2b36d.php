...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Pending Quotes')); ?>
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <h4 class="header-title"><?php echo e(__('All Pending Quotes')); ?></h4>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != ''){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.quote.manage.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/quote-manage/quote-manage-pending.blade.php ENDPATH**/ ?>