    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Payment Report")); ?></h4>
                        <form action="<?php echo e(route('admin.payment.report')); ?>" method="get" enctype="multipart/form-data" id="report_generate_form">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SANAUL\Desktop\code canyan\cleaning\@core\resources\views/backend/payment-logs/payment-report.blade.php ENDPATH**/ ?>