<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Order For')); ?> <?php echo e(' : '.$order_details->lang_front->title); ?>
                ...
                <div class="right-content-area">
                    <div class="single-price-plan-01 active">
                        <div class="price-header">
                            ...
                            <h4 class="title"><?php echo e($order_details->lang_front->title); ?></h4>
                        </div>
                        <div class="price-body">
                            <ul>
                                <?php $__currentLoopData = explode("\n",$order_details->lang_front->features); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><i class="fa fa-check success"></i> <?php echo e($item); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <div class="price-wrap">
                            <?php echo custom_amount_with_currency_symbol($order_details->price); ?> <span class="sign"><?php echo e($order_details->lang_front->type); ?></span>
                        </div>
                        <div class="price-footer">
                            <div class="btn-wrapper">
                                <a href="<?php echo e(($order_details->btn_url)?? route('frontend.plan.order',['id' => $order_details->id])); ?>" class="boxed-btn"><?php echo e($order_details->lang_front->btn_text); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/pages/package/order-page.blade.php ENDPATH**/ ?>