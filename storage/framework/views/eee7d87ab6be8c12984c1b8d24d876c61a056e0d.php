                            ...
                            <div class="form-group">
                                ...
                                <select name="categories_id" id="category" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $service_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($service->categories_id == $data->id): ?> selected <?php endif; ?> value="<?php echo e($data->id); ?>"><?php echo e(purify_html($data->lang->name)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="price_plan[]" multiple class="form-control nice-select wide">
                                    ...
                                    <?php $__currentLoopData = $price_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>" <?php if(is_array($select_plan) && in_array($data->id,$select_plan)): ?> selected <?php endif; ?>><?php echo e(purify_html($data->lang->title)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/pages/service/edit-service.blade.php ENDPATH**/ ?>