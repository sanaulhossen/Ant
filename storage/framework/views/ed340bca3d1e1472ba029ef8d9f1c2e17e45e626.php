                                ...
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="order_mail_<?php echo e($lang->slug); ?>_success_message"  class="form-control" value="<?php echo e(get_static_option('order_mail_'.$lang->slug.'_success_message')); ?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact_mail_<?php echo e($lang->slug); ?>_success_message"  class="form-control" value="<?php echo e(get_static_option('contact_mail_'.$lang->slug.'_success_message')); ?>" >
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/general-settings/email-settings.blade.php ENDPATH**/ ?>