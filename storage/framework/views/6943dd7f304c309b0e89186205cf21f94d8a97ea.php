...
<head>
    ...
    <title><?php echo e(__('Request Quote From ')); ?> <?php echo e(get_static_option('site_'.get_default_language().'_title')); ?></title>
...
<body>
    <div class="mail-container">
      ...
      <div class="inner-wrap">
          <p><?php echo e(__('Hello')); ?> <br> <?php echo e(__('You Have A Quote From')); ?> <?php echo e(get_static_option('site_'.get_default_language().'_title')); ?></p>
          <table>
              <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <tr>
                      ...
                      <td><?php echo e(htmlspecialchars(strip_tags($field))); ?></td>
                  </tr>
...
</html><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/mail/request-quote.blade.php ENDPATH**/ ?>