                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapp">
                            <h4 class="header-title"><?php echo e(__('Edit New Popup')); ?>  </h4>
                            <h4 class="header-title">
                                <a href="<?php echo e(route('admin.popup.builder.all')); ?>" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('All Popup')); ?></a>
                            </h4>
                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/general-settings/popup-edit.blade.php ENDPATH**/ ?>