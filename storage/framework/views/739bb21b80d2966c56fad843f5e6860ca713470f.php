<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Quote Form Builder')); ?>
...
<?php endif; ?>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__("Quote Form Builder")); ?></h4>
                        <form action="<?php echo e(route('admin.form.builder.quote')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup(get_static_option('quote_page_form_fields')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/backend/form-builder/quote-form.blade.php ENDPATH**/ ?>