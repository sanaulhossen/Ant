            ...
            <div class="row justify-content-center margin-top-90 margin-bottom-90">
                <div class="col-lg-6">
                    <div class="login-form-wrapper">
                        <h3 class="text-center margin-bottom-30"><?php echo e(__('Forget Password ?')); ?></h3>
                        ...
                        <form action="<?php echo e(route('user.forget.password')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group btn-wrapper">
                                <button type="submit" id="send" class="boxed-btn btn-saas btn-block"><?php echo e(__('Send Reset Mail')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/neateller/@core/resources/views/frontend/user/forget-password.blade.php ENDPATH**/ ?>