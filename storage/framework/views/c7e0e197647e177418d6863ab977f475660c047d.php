                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <a tabindex="0" style="display: none" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1" role="button" data-placement="right"  data-toggle="popover" data-trigger="focus" data-html="true" title="" data-content="
                                                       ...
                                                       <br>
                                                        <input type='submit' class='btn btn-danger btn-sm media_library_image_delete_btn' value='<?php echo e(__('Yes, Delete')); ?>'>
                                                        </form>
                                                        " data-original-title="">
                                            <i class="ti-trash"></i>
                                        </a>
...
</div><?php /**PATH /Users/sharifur/Desktop/sharifur-backup/localhost/neateller-laravel/@core/resources/views/backend/partials/media-upload/media-upload-markup.blade.php ENDPATH**/ ?>